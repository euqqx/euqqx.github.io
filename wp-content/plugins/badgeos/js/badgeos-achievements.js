    ...
    if ('undefined' != typeof BadgeosCredlyData) {
        ...
        $body.on('click', '.credly-share', function(event) {
            ...
            credly.width(width).css({
                top: Math.floor(elPosition.top - credly.outerHeight()),
                left: Math.floor(elPosition.left)
        ...
        function credlyHide() {
            ...
            credlyMessage.hide().css({
                opacity: 1.0
            }).html(BadgeosCredlyData.errormessage);
        ...
        function badgeos_send_to_credly(ID) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    credlyMessage.fadeTo('fast', 1).animate({
                        opacity: 1.0
                    }, 2000).fadeTo('slow', 0).html(response);
