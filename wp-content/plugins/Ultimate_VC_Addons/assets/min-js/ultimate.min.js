...
function make_info_circle(a, b) {
    jQuery(a).each(function(a, b) {
        ...
        jQuery(jQuery(b).find(".icon-circle-list .info-circle-icons")).each(function(a, d) {
            var e, f, g, h, i = jQuery(d).hasClass("info-circle-icon-without-background") ? !0 : !1;
            ...
            return jQuery(this).each(function() {
                ...
                var P = function() {
                    ...
                    if (d = c, resize_selector = d.find(".upb_video-bg"), "full" == k && (d = jQuery("body")), "ex-full" == k && (d = jQuery("html")), !isNaN(k))
                        for (var g = 0; k > g && "HTML" != d.prop("tagName"); g++) d = d.parent();
        ...
        var h = function() {
            jQuery(".upb_row_bg").each(function() {
                ...
                var k = (parseInt(c.css("paddingLeft")), parseInt(c.css("paddingRight")), parseInt(c.css("marginLeft")), c.outerWidth()),
                    ...
                    o = c.offset().left,
                    p = o - m;
                0 > n && (p = n + p), 0 == a && (g = n), g > 0 && (p = g), p > 0 && (p = 0), "undefined" == typeof f || f !== !0 && "true" !== f ? jQuery(this).css({
                    width: k,
                    "min-width": k,
                    left: p
                }) : jQuery(this).css({
...
var fixto = function(a, b, c) {
    ...
    q && (l = parseFloat(navigator.appVersion.split("MSIE")[1])), f.prototype = {
        _mindtop: function() {
            var a = 0;
            if (this._$mind)
                for (var b, c, d = 0, e = this._$mind.length; e > d; d++)
        ...
        _saveStyles: function() {
            var a = this.child.style;
            this._childOriginalPosition = a.position, this._childOriginalTop = a.top,
                this._childOriginalWidth = a.width, this._childOriginalLeft = a.left
        },
        _onresize: function() {
            this.refresh()
        },
...
jQuery(document).ready(function() {
        make_info_circle(".info-c-full-br", 0), responsive_check(".info-c-full-br"), calculate_clipped_circle(), jQuery(".clipped-info-circle").each(function(a, b) {
            ...
            resizedd++, make_info_circle(".info-c-full-br", resizedd),
        ...
        function c() {
            elements = a("div.ult-sticky-anchor"), elements.each(function() {
                var b = a(this),
                    ...
                    h = c.data("mobile"),
                    i = b.find(".ult-space");
                if (768 > f && "no" == h) return c.removeClass("ult-stick"), i.css("height", ""), void b.removeClass("ult-permanent-flag");
                var j = e.scrollTop(),
                    k = b.offset().top,
                    l = e.height(),
        ...
        var b = {
            ...
            d = {
                ...
                next: function(b) {
                    ...
                    return d ? d.animating || d.itemCount < 2 ? !1 : (c.restartInterval.call(this), void c.moveUp(d, b)) : void 0
                },
                prev: function(b) {
                    var d = a(this).data("state");
                    return d ? d.animating || d.itemCount < 2 ? !1 : (c.restartInterval.call(this), void c.moveDown(d, b)) : void 0
                },
                stop: function() {
                    var b = a(this).data("state");
                    return b ? void c.stopInterval.call(this) : void 0
                },
                remove: function() {
                    var b = a(this).data("state");
                    if (!b) return void 0;
